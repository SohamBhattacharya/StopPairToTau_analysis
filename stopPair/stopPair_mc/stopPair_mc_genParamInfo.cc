...
# include "HeaderFiles/GetGenParamInfo.h"
...
int main()
{
    ...
    )
    {
        ...
        //dir = "stopPair_mc/output_genParam/SMS-T8bbstausnu_XCha0p5_XStau0p5_TuneCUETP8M1_13TeV-madgraphMLM-pythia8_Summer16";
        ...
        dir = "stopPair_mc/output_genParam/SMS-T8bbstausnu_mStop-200to1800_XCha0p5_XStau0p5_TuneCP2_13TeV-madgraphMLM-pythia8_Fall17";
        otherInfoDir = "stopPair_mc";
