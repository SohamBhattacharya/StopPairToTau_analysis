...
cutFlowDir_tauTau_fakeEstimation = {
    "2016": [
...
cutFlowDir_muMu_tauTemplateMethodEstimation = [
...
# Not related to the signal points above
l_color_sig = [
    ROOT.kMagenta+2,
    4,
    ROOT.kOrange+8,
    ...
    ROOT.TColor.GetColorBright(46),
    38,
    ROOT.TColor.GetColorDark(44),
    ROOT.TColor.GetColorDark(41),
    ROOT.TColor.GetColorDark(30)
]
...
cutFlowDir_WJetsToLNu_tauTemplateMethodEstimation = [
...
cutFlowDir_DYJetsToLL_tauTemplateMethodEstimation = [
...
inclusiveCrossSection_DYJetsToLL = 6225.0
...
cutFlowDir_VH_tauTemplateMethodEstimation = [
...
cutFlowDir_VV_tauTemplateMethodEstimation = [
...
# WG
cutFlowDir_WG_tauTemplateMethodEstimation = [
...
cutFlowDir_singleTop_tauTemplateMethodEstimation = [
...
cutFlowDir_ttbar_tauTemplateMethodEstimation = [
...
color_QCD = ROOT.kMagenta-9 #6


# Other SM

label_otherSM = ["OtherSM"]
latex_otherSM = "Other SM"
color_otherSM = ROOT.TColor.GetColorBright(9) #46
