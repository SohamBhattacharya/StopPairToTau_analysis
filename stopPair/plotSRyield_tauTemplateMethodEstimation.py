...
for iSR in range(0, nSR) :
    ...
    #)
    h1_cutFlow_data = Common.getCombinedCutFlow(
        inputFiles = inputFiles_templateMethod,
        cutFlowName = cutFlowName,
    ...
    if (printTable) :
        ...
        with numpy.errstate(divide = "ignore", invalid = "ignore") :
            ...
            os.system("mkdir -p cutFlowTables_tauTemplateMethodEstimation")
...
if (printTable) :
    ...
    cutFlowFileName = "cutFlowTables_tauTemplateMethodEstimation/cutFlow_" + cutFlowNameBase + "all.txt"
    print "Writing:", cutFlowFileName
...
if (plotYield) :
    ...
    print "*****"
    print h1_yield_data.GetBinContent(6), h1_yield_data.GetBinError(6)
    print h1_yieldSum_mc.GetBinContent(6), h1_yieldSum_mc.GetBinError(6)
    print "*****"
    ...
    canvas.SaveAs("%s/SRyield_tauTemplateMethodEstimation_%s.pdf" %(plotDir, cutFlowNameBase))
